...
public class ItemGearTemporal extends ItemBaseComponentGeneric implements IDisassemble
{
    @Override
    ...
    public void disassemble(World world, double x, double y, double z, ItemStack is)
    {
        if(!world.isRemote)
        {
            DisassembleHelper.disassembleMetalGear(world, x, y, z, is, "ingotTemporal");
        }
    }
}
