...
public class MechanicTweaker
{
    ...
    public static int TIME_SAND_FROM_NATURAL_SPAWN = 5000; //Life
    public static int TIME_SAND_FROM_LIGHT_SECOND = 100; //Light
    public static int TIME_SAND_FROM_WATER_SECOND = 100; //Water
    public static int TIME_SAND_FROM_TREE_EXTRACTION = 500; //Earth
    public static int TIME_SAND_FROM_AIR_SECOND = 100; //Air
    public static int TIME_SAND_FROM_ONE_FIRE_DAMAGE = 300; //Fire
    public static int TIME_SAND_FROM_MOON_SECOND = 100; //Lunar
    public static int TIME_SAND_FROM_DEATH = 2000; //Death
    ...
    public static int LIFE_HOURGLASS_TENSION_COST = 500; //Once per tick.
    public static int LIGHT_HOURGLASS_TENSION_COST = 500; //Once per light.
    public static int WATER_HOURGLASS_TENSION_COST = 80; //Once per tick.
    public static int EARTH_HOURGLASS_TENSION_COST = 20; //Once per tick.
    public static int AIR_HOURGLASS_TENSION_COST = 50; //Once per tick.
    public static int FIRE_HOURGLASS_TENSION_COST = 120; //Once per tick.
    public static int LUNAR_HOURGLASS_TENSION_COST = 50; //Once per tick.
    public static int DEATH_HOURGLASS_TENSION_COST = 250; //Once per tick.

    public static int CLOCKWORK_ARMOR_TENSION_COST = 250; //Once per hit (Applies to each piece of armor).

    public static int TENSION_PER_BLOCK_BREAK = 250; //For clockwork tools, applies once each time a block is broken.
    public static int TENSION_PER_HIT = 500; //For clockwork saber, applies once each time an entity is hit.
    ...
    public static int TIME_SAND_COST_SILK_MODULE = 25; //Silk touch module, once per block silk-touched.
    public static int TIME_SAND_COST_FURNACE_MODULE = 25; //Furnace module, once per block auto-smelted.
    public static int TIME_SAND_COST_LIFE_WALK_MODULE = 3; //Life walk module, amount of time sand per health power.
    public static int TIME_SAND_COST_PART_GRAVITY_MODULE = 2; //Lunar boots, amount of time sand per active tick.
    public static int TIME_SAND_COST_DEATH_WALK_MODULE = 10; //Death walk module, amount of time sand per death power.
