...
public class EntityElementalAttunementFX extends EntityClockworkPhaseFX
{
    ...
    public EntityElementalAttunementFX(World world, double x, double y, double z, double xMotion, double yMotion, double zMotion)
    {
    ...
    {
        return ParticleResourceLocations.ELEMENTAL_ATTUNEMENT;
    }
