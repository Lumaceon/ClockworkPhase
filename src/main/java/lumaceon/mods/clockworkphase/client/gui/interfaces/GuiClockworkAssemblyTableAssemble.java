...
public class GuiClockworkAssemblyTableAssemble extends GuiContainer
{
    ...
    public void initGui()
    {
        ...
        buttonList.clear();
        buttonList.add(new GuiButtonItem(mainspring, 0, guiLeft + 24 - 9, guiTop + 211 - 9, "", itemRenders, fontRenderer));
        buttonList.add(new GuiButtonItem(clockwork, 1, guiLeft + 231 - 9, guiTop + 211 - 9, "", itemRenders, fontRenderer));
    }
