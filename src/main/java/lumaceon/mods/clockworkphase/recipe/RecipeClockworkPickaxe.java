...
public class RecipeClockworkPickaxe implements IRecipe
{
    @Override
    public boolean matches(InventoryCrafting ic, World world)
    {
        ...
        for(int n = 0; n < ic.getSizeInventory(); n++)
        {
            ...
            if(item != null)
            {
                ...
                //101
                //101
                else if(n == 3 || n == 5 || n == 6 || n == 8)
                {
                    return false;
                }
            }
            else if(n == 0 || n == 1 || n == 2 || n == 4 || n == 7)
            {
                return false;
            }
        }
    ...
    {
        ItemStack output = new ItemStack(ModItems.clockworkPickaxe);
    ...
    {
        return new ItemStack(ModItems.clockworkPickaxe);
    }
}
