...
public class RecipeClockworkShovel implements IRecipe
{
    @Override
    public boolean matches(InventoryCrafting ic, World world)
    {
        ...
        for(int n = 0; n < ic.getSizeInventory(); n++)
        {
            ...
            if(item != null)
            {
                ...
                else if(n == 0 || n == 2 || n == 3 || n == 5 || n == 6 || n == 8)
                {
                    return false;
                }
            }
    ...
    {
        ItemStack output = new ItemStack(ModItems.clockworkShovel);
    ...
    {
        return new ItemStack(ModItems.clockworkShovel);
    }
}
